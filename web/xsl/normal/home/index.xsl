...
<div style="font-size:130%">
  <p>
  <xsl:text>Россия располагает одной из самых мощных транспортных систем в мире. В эту систему входят наземный (автомобильный, железнодорожный и метро), воздушный, водный (морской и речной) транспорт. Каждый вид транспорта представляет собой совокупность средств, путей сообщений, технических устройств и сооружений, относящихся к транспортной инфраструктуре.
  </xsl:text>
  </p>
  <p>
  <xsl:text>﻿Именно транспортная система обеспечивает эффективную работу всех отраслей народного хозяйства, жизнеспособность экономики страны, а также нормальную жизнедеятельность населения.
  </xsl:text>
  </p>
  <p>
  <xsl:text>Вот почему задачи надежности и безопасности транспортной системы – это первоочередные задачи любого промышленно-развитого государства.
  </xsl:text>
  </p>
  <p>
  <xsl:text>Под транспортной безопасностью понимают совокупность мер, призванных защитить интересы государства и общества, а также жизнь и здоровье пассажиров от внутренних и внешних угроз в транспортной сфере. Эти меры направлены на:
  </xsl:text>
  </p>
  <ul>
