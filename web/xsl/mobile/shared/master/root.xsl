            ...
            <form id="search-form" action="/Mobile/Search/" method="POST">
                <xsl:choose>
                    <xsl:when test="not(/data/meta/search-param) or (/data/meta/search-param = '')">
                        <input id="search-field" type="search" size="32" name="q" autocapitalize="off" autocorrect="off"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <input id="search-field"  type="search" size="32" name="q" autocapitalize="off" autocorrect="off" value="{/data/meta/search-param}"/>
                    </xsl:otherwise>
                </xsl:choose>
