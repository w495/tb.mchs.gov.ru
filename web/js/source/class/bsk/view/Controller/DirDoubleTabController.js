...
qx.Class.define("bsk.view.Controller.DirDoubleTabController",
{
    ...
    // ----------------------------------------------------------------------
        ...
        this.left = new bsk.view.Controller.TabController(biz, Data, FilterVal, tabModels.left);
        ...
        this.left._tabChangeState = function(actionUrl) {
            ...
            //\ var newVardata = bsk.util.utils.clone(vardata)
    ...
    // ----------------------------------------------------------------------
        ...
        this.right = new bsk.view.Controller.TabController(biz, Data, FilterVal, tabModels.right);
