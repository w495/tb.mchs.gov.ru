...
qx.Class.define("bsk.view.Form.Format.RichTextArea",
{
    /// 
...
qx.Class.define("bsk.view.Form.Format.RichTextArea",
{
    ...
    this.base(arguments, new qx.ui.layout.VBox());
        ...
        this.htmlArea = new qx.ui.embed.HtmlArea(bsk.view.Form.Format.RichTextArea.descriptionText, null, "blank.html");
