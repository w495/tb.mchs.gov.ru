...
qx.Class.define("bsk.view.Form.TestAnswerForm",
{
    ...
    members : {
        ...
        **/
        buildForm : function() {
            ...
            cnt.add(new qx.ui.basic.Label().set({value: "Правильный" + RFM,  rich : true}),
                    {row:++vertical_offset, column:0});
            cnt.add(this.inp.Correct_flag, {row:vertical_offset , column:1});
