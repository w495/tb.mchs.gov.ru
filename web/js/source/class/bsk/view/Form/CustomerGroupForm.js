...
qx.Class.define("bsk.view.Form.CustomerGroupForm",
{
    ...
    members : {
        ...
        buildForm : function() {
            ...
            this.permissionList = new bsk.view.SelListTree(this,
        ...
        validateForm : function() {
            ...
            flag &= bsk.view.Form.AbstractForm.customFormChkLength(1, 50, this.inp.Description);
            return flag
        },
